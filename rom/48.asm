...
;; S-LOOP-1
L24FF:  CALL    L2D1B           ; routine NUMERIC will reset carry if so.
        JP      NC,L268D        ; forward to S-DECIMAL if so.

        CALL    L2C8D           ; routine ALPHA will set carry if so.
        JP      C,L26C9         ; forward to S-LETTER if so.
